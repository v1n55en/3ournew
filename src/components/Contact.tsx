        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            >
              ...
              <option value="social_branding">Social Media Branding</option>
              <option value="social_boosting">Social Media Boosting</option>
              <option value="social_creators">Social Media Creators</option>
              <option value="social_combo">Social Media Combo</option>
              <option value="web_development">Web Development</option>
              <option value="seo_management">SEO Management</option>
            ...
            <div className="bg-black rounded-lg shadow-lg p-8 text-white h-full">
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300">info@3our-agency.com</p>
                  </div>
                </div>
              ...
              <div className="mt-8 pt-8 border-t border-gray-800">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-[#599d39] transition-colors">
